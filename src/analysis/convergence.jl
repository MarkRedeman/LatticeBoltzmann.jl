function test_convergence(problem::Problem, scales) where {Problem<:FluidFlowProblem} end

function analyze_convergence(q::Quadrature, p, viscosity::Float64, N = 2, t_end = 2pi)
