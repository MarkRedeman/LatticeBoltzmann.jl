...
function taylor_green_vortex_velocity_profile(
    q = D2Q9(),
...
# plot(
#     plot(
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results, :error_u), title="Zero"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_iterative, :error_u), title = "iterative"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_equilibrium, :error_u), title = "equilibrium"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_offequilibrium, :error_u), title = "offequilibrium"),
#         legend = nothing,
#     ),

#     plot(
#         # plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results, :error_p), title="Zero"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_iterative, :error_p), title = "iterative"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_equilibrium, :error_p), title = "equilibrium"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_offequilibrium, :error_p), title = "offequilibrium"),
#         legend = nothing,
#     ),

#     plot(
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results, :error_σ_xy), title="Zero"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_iterative, :error_σ_xy), title = "iterative"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_equilibrium, :error_σ_xy), title = "equilibrium"),
#         plot(Examples.TaylorGreenVortex.plot_convergence(biggest_result.convergence_results_offequilibrium, :error_σ_xy), title = "offequilibrium"),
#         legend = nothing,
#     ),
#     size=(1200, 900)
# )
